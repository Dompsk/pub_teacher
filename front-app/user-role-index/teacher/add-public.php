...
// เตรียมข้อมูลสำหรับ Supabase (เก็บ path เต็ม)
$data = [
    "pub_id" => $new_pub_id,
    "pub_name" => $pub_name,
    "c_id" => $c_id,
...
<body>
    ...
    <main>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <button type="button" class="btn btn-cancel" onclick="window.location.href='index-role-teacher.php'">
                ยกเลิก
            </button>
            <button type="submit" name="save_pub" class="btn btn-save">
                เพิ่มบทความ
            </button>
        </form>
    </main>
